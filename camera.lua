...
function updateCamera(dotToUse)
  if (dotToUse.x < (cameraX + 1/5*love.graphics.getWidth()/30)) and (1/5*love.graphics.getWidth()/30 < dotToUse.x) then
  ...
  if (dotToUse.y < (cameraY + 1/5*love.graphics.getHeight()/30)) and (1/5*love.graphics.getHeight()/30 < dotToUse.y) then
